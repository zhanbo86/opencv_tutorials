...
//  cvNamedWindow("proceed2", CV_WINDOW_AUTOSIZE);
  clock_t a=clock();
  cout<<"a = "<<a<<endl;
  Mat img = imread("piece_std2.jpg",CV_LOAD_IMAGE_ANYDEPTH|CV_LOAD_IMAGE_ANYCOLOR);
  Mat img2 = imread("11.bmp",CV_LOAD_IMAGE_ANYDEPTH|CV_LOAD_IMAGE_ANYCOLOR);
//  cvSetMouseCallback("source",my_mouse_callback,NULL);

//  cvtColor(img,img,CV_BGR2GRAY);
//  cout<<"img2.depth = "<<img2.depth()<<"\t"<<"img2.channels = "<<img2.channels()<<endl;
